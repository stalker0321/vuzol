...
OpenRouter profiles may additionally declare a bounded `provider_routing` table. The production
policy sorts by price, prefers endpoints with p90 throughput of at least 70 tokens per second,
